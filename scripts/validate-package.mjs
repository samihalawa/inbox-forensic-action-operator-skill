...
const requiredScenarioIds = [
  ...
  'MAIL-SEND-PROOF', 'TWENTY-AUDIT-ALLOWLIST', 'TWENTY-FAILURE-TAXONOMY', 'BROWSER-OF-MANY',
  ...
  'FAILURE-ORIGIN', 'AUDIT-NO-MUTATION', 'AMBIGUOUS-MUTATION', 'LIVE-SEND-AUTHORITY',
  'MISSING-MUTATION-SCOPE', 'MAIL-HALF-OPEN-DST', 'MAIL-ID-NAMESPACE', 'MAIL-THREAD-CAP',
  ...
  'OPPORTUNITY-TRUTH-FULL', 'OPPORTUNITY-CRITICAL-LOSS', 'OPPORTUNITY-CONVERGENCE',
  'TTS-ENGLISH-FULL', 'TTSC-CHINESE-PROGRESS',
  'CRM-FIRST-STALE-OVERLAY', 'EMAIL-FOLDER-NOT-PIPELINE', 'DATE-DECAY-NO-INFERENCE',
  'SAME-COMPANY-ROLE-SEPARATION',
];
...
const criticalExpectations = [
  ...
  ['TWENTY-AUDIT-ALLOWLIST', 5, 'blocked'],
